...
//                }
                    ...
                    solvedLabel.setText("NO SOLUTION !");
                    TA.setText("HAHAHA DUPLICATE !");
                    r = 0;
                    c = 0;
                }
...
//        }
    ...
    public boolean isDuplicateRow(){
        ...
        boolean st = false;
        java.util.Set<Integer> row1 = new HashSet();
        int row1uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[0][j] != 0){
                row1uni++;
        ...
        if(row1uni == row1.size()) {st =  true;}
        else st = false;
        
        java.util.Set<Integer> row2 = new HashSet();
        int row2uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[1][j] != 0){
                row2uni++;
        ...
        if(row2uni == row2.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row3 = new HashSet();
        int row3uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[2][j] != 0){
                row3uni++;
        ...
        if(row3uni == row3.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row4 = new HashSet();
        int row4uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[3][j] != 0){
                row4uni++;
        ...
        if(row4uni == row4.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row5 = new HashSet();
        int row5uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[4][j] != 0){
                row5uni++;
        ...
        if(row5uni == row5.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row6 = new HashSet();
        int row6uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[5][j] != 0){
                row6uni++;
        ...
        if(row6uni == row6.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row7 = new HashSet();
        int row7uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[6][j] != 0){
                row7uni++;
        ...
        if(row7uni == row7.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row8 = new HashSet();
        int row8uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[7][j] != 0){
                row8uni++;
        ...
        if(row8uni == row8.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row9 = new HashSet();
        int row9uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[8][j] != 0){
                row9uni++;
        ...
        if(row9uni == row9.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row11 = new HashSet();
        int row11uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[j][0] != 0){
                row11uni++;
        ...
        if(row11uni == row11.size()) {st =  true;}
        else st = false;
        
        java.util.Set<Integer> row22 = new HashSet();
        int row22uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[j][1] != 0){
                row22uni++;
        ...
        if(row22uni == row22.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row33 = new HashSet();
        int row33uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[j][2] != 0){
                row33uni++;
        ...
        if(row33uni == row33.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row44 = new HashSet();
        int row44uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[j][3] != 0){
                row44uni++;
        ...
        if(row44uni == row44.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row55 = new HashSet();
        int row55uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[j][4] != 0){
                row55uni++;
        ...
        if(row55uni == row55.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row66 = new HashSet();
        int row66uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[j][5] != 0){
                row66uni++;
        ...
        if(row66uni == row66.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row77 = new HashSet();
        int row77uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[j][6] != 0){
                row77uni++;
        ...
        if(row77uni == row77.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row88 = new HashSet();
        int row88uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[j][7] != 0){
                row88uni++;
        ...
        if(row88uni == row88.size()) st =  true;
        else st = false;
        
        java.util.Set<Integer> row99 = new HashSet();
        int row99uni = 0;
        for(int j = 0; j < board.length; j++){
            if(board[j][8] != 0){
                row99uni++;
        ...
        if(row99uni == row99.size()) st =  true;
        else st = false;
    ...
    public boolean checkFirstRow(){
        java.util.Set<Integer> fir = new HashSet();
                
        for(int i = 0; i < board.length; i++){
            
            fir.add(board[0][i]);
        }
        if(fir.size() != 9) return false;
        return true;
    }
